        ...
        while(true){
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    executor.submit(new WithdrawTask(account, account.getBalance() / 2));
                    executor.submit(new WithdrawTask(account, account.getBalance() / 2));
                    break;
                case 5:
                ...
                case 8:
                    ...
                    while (true) {
                        ...
                        if (bankList.containsKey(accountNumber1)) {
                    ...
                    while (true) {
                        ...
                        executor.submit(new Transactions(account, accountNumber, account1, accountNumber1, amount));
                        break;
                case 9:
                    List<String> th= account.getTransactionHistory();
